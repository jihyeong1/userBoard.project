...
<%
	...
	System.out.println(request.getParameter("oldMemberPw") + " <-- updatePasswordAction prameter oldMemberPw");
	System.out.println(request.getParameter("memberPw") + " <-- updatePasswordAction prameter memberPw");
	System.out.println(request.getParameter("updateMemberPw") + " <-- updatePasswordAction prameter updateMemberPw");
	// 요청값 유효성 검사
	...
	if(request.getParameter("memberPw") == null						// 비밀번호 정보나 비밀번호 확인정보가 없으면 회원정보 폼으로
		...
		|| request.getParameter("updateMemberPw") == null
		|| request.getParameter("updateMemberPw").equals("")) {
	...
	String updateMemberPw = request.getParameter("updateMemberPw");
	// 요청값 디버깅
	...
	System.out.println(updateMemberPw + " <-- updatePasswordAction prameter updateMemberPw");
	
	if(!memberPw.equals(updateMemberPw)) {		// 새로운 비밀번호와 비밀번호 확인이 같지 않다면 비밀번호 수정 폼으로
